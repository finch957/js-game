...
//#region level generation
    ...
    #spawnMobs() {
        const rat_count = Math.floor(this.#index / 4) + (this.#bspDivisions - 1) * 3;
        ...
        const gelatine_count = Math.floor(Math.max(Math.random(), 0.5) * this.#index / 5 * (this.#bspDivisions - 1) * 2);
